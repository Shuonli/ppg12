...
# Update PNG save paths
for i, line in enumerate(source):
    if 'png_name = f"truth_purity_{i}.png"' in line:
        source[i] = '    "            png_name = f\\"{output_dir}/truth_purity_{i}.png\\"\\n",'
    elif 'png_name_total = f"total_tight_iso_clusters_{i}.png"' in line:
        source[i] = '    "            png_name_total = f\\"{output_dir}/total_tight_iso_clusters_{i}.png\\"\\n",'
    elif 'png_name_rel_err = f"total_tight_iso_clusters_rel_err_{i}.png"' in line:
        source[i] = '    "            png_name_rel_err = f\\"{output_dir}/total_tight_iso_clusters_rel_err_{i}.png\\"\\n",'
    elif 'comb_png = "truth_purity_all.png"' in line:
        source[i] = '    "            comb_png = f\\"{output_dir}/truth_purity_all.png\\"\\n",'
    elif 'comb_total_png = "total_tight_iso_clusters_all.png"' in line:
        source[i] = '    "            comb_total_png = f\\"{output_dir}/total_tight_iso_clusters_all.png\\"\\n",'
    elif 'comb_rel_err_png = "total_tight_iso_clusters_rel_err_all.png"' in line:
        source[i] = '    "            comb_rel_err_png = f\\"{output_dir}/total_tight_iso_clusters_rel_err_all.png\\"\\n",'
...
print('Successfully updated the Truth Purity Plots cell with output directory functionality')
