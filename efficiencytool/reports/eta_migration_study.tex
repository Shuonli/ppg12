...
Table~\ref{tab:abcd_regions} summarizes the contamination by region for the
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
    ...
    \caption{Response matrix contamination (tight+iso fake fraction) vs.\ $\ET$
      for single and double interaction.}
    \label{fig:response}
  \end{minipage}
  \hfill
  \begin{minipage}[t]{0.48\textwidth}
