...
// Return the mix weight for a given MC file ("photon10" = single, "photon10_double"
...
void VertexReweightAltPhoton()
{
    ...
    {
        const std::string tag = is_double ? "photon10_double" : "photon10";
