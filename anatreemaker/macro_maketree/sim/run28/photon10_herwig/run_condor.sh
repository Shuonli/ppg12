...
export dstpath="/sphenix/user/shuhangli/ppg12/anatreemaker/macro_maketree/sim/run28/photon10_herwig"
# Path to the output directory
export TargetDir="/sphenix/user/shuhangli/ppg12/anatreemaker/macro_maketree/sim/run28/photon10_herwig/condorout"
# Total events for this condor. (1 line = 1 DST file)
total_line=3081
# Events per job (1 line = 1 DST file)
lines_per_job=10
