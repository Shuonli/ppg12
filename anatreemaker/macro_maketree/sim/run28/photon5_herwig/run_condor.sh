...
export dstpath="/sphenix/user/shuhangli/ppg12/anatreemaker/macro_maketree/sim/run28/photon5_herwig"
# Path to the output directory
export TargetDir="/sphenix/user/shuhangli/ppg12/anatreemaker/macro_maketree/sim/run28/photon5_herwig/condorout"
