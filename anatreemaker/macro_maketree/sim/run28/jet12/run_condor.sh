...
export dstpath="/sphenix/user/shuhangli/ppg12/anatreemaker/macro_maketree/sim/run28/jet12"
# Path to the output directory
export TargetDir="/sphenix/user/shuhangli/ppg12/anatreemaker/macro_maketree/sim/run28/jet12/condorout"
