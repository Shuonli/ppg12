...
{
  init_plot();
  string varStr = "CNNvar";
  string savePath = "figures";

  TFile *f1 = new TFile("/sphenix/user/shuhangli/ppg12/efficiencytool/results/Photon_final_nom.root");
  TFile *f2 = new TFile("/sphenix/user/shuhangli/ppg12/efficiencytool/results/Photon_final_CNNVar.root");

  string legf1 = "nominal";
  string legf2 = "CNN > 0.8 tight";
  ...
  std::pair<TH1F *, TH1F *> h_dev_pair = calcDelta(h_res_1, h_res_2, "h_dev");
