...
void plot_paper_iso_template_yj(const std::string &tune = "bdt_nom")
{
    paper_init(0);
    ...
    h_tight_isoET->GetYaxis()->SetTitleOffset(1.55);
    ...
    float xpos(0.915), ypos(0.875), dy(0.054), dy1(0.06), fontsize(0.046), fontsize1(0.051);
    ...
    l1->AddEntry(h_tight_isoET,       "Data (Tight ID)",     "pe");
    l1->AddEntry(h_nontight_isoET,    "Data (Non-tight ID)", "f");
