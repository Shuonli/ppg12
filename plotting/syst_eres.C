...
void syst_eres()
{
  ...
  TFile *f2 = new TFile(Form("/sphenix/user/shuhangli/ppg12/efficiencytool/results/Photon_final_eres.root"));
  TFile *f3 = new TFile(Form("/sphenix/user/shuhangli/ppg12/efficiencytool/results/Photon_final_eres.root"));

  string legf1 = "nominal";
  string legf2 = "energy res. var.";
  string legup = "energy res. var.";
  ...
  init_plot();
  frame_et_truth->SetYTitle("Relative difference");
  frame_et_truth->GetYaxis()->SetRangeUser(-0.2, 0.15);
