...
void GoldenFEMrunListGenerator() {
  std::string runnumber_file_path = "FileLists/runNumbers_with_AtLeast_OneMilEventsAfterRun46619.txt";
  std::string output_file_path = "FileLists/GoldenFEMrunList.txt";
  ...
  while (std::getline(runnumber_file, runnumber)) {
    std::string clock_file_path = "FileLists/list_allFEM_clock/FEM_clock_" + runnumber + ".txt";
  ...
  std::cout << "Number of FEM GOLDEN runs saved to GoldenFEMrunList.txt: " << passedRunCount << std::endl;
