...
void analyzeRuns(const std::string& inputFileName, const std::string& outputFileName1) {
  ...
  std::ofstream errorFile("FileLists/list_eventnumber_errorlog.txt");
  ...
  std::cout << "Number of GL1 GOLDEN runs saved to GoldenGL1RunList.txt: " << passedRunCount << std::endl;
...
void GoldenGL1RunListGenerator() {
  analyzeRuns("FileLists/EventNumberList_runsWithOver1million.txt", "FileLists/GoldenGL1RunList.txt");
}
