...
root -l -b -q 'RecoEffCalculator.C("'"${CONFIGNAME}"'", "jet15")'
root -l -b -q 'RecoEffCalculator.C("'"${CONFIGNAME}"'", "jet10")'
#root -l -b -q 'RecoEffCalculator.C("'"${CONFIGNAME}"'", "jet20")'
#root -l -b -q 'RecoEffCalculator.C("'"${CONFIGNAME}"'", "jet30")'
